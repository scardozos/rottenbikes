...
func TestHandleListAllReviewsWithRatings(t *testing.T) {
	mockService := &MockService{
	...
	t.Run("success", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/bikes/reviews", nil)
		w := httptest.NewRecorder()
...
func TestHandleBikeReviews(t *testing.T) {
	mockService := &MockService{
	...
	t.Run("success", func(t *testing.T) {
		req := httptest.NewRequest(http.MethodGet, "/bikes/1/reviews", nil)
		w := httptest.NewRecorder()
